...
function _emscripten_run_script_string(ptr) {
    ...
    tmp = tmp.replace("parent.document.location.href",'"https://poki.com/en/g/winter-clash-3d"');
    tmp = tmp.replace("window.document.referrer",'"https://poki.com/en/g/winter-clash-3d"');
    var s;
