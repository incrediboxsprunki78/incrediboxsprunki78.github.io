...
function _emscripten_run_script_string(ptr) {
    ...
    tmp = tmp.replace("parent.document.location.href",'"https://clash3d.com/vegasclash3d"');
    tmp = tmp.replace("window.document.referrer",'"https://clash3d.com/vegasclash3d"');
    tmp = tmp.replace("document.location.ancestorOrigins[document.location.ancestorOrigins.length-1];",'"https://clash3d.com/vegasclash3d";');
    var s;
